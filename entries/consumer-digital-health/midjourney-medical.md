---
id: midjourney-medical
name: Midjourney Medical
website: midjourney.com/medical
founded: 2026
...
moat:
  ...
  - IP
input:
  - full-body ultrasonic CT scan data
  - consumer self-reported health history
transformation_type: measure
output:
  - full-body anatomical imaging report
  - early disease signal flags
  - physician-reviewed health summary
barrier_to_entry: high
barrier_to_entry_logic: Novel hardware development for a new imaging modality requires deep physics, engineering, and regulatory expertise with long development cycles and FDA De Novo or 510(k) clearance.
hardness: moonshot
hardness_reason: Building ultrasonic CT achieving MRI-equivalent diagnostic sensitivity in 60 seconds and securing FDA clearance for a modality with no established clinical validation pathway.
---

## One-liner

Develops a 60-second full-body ultrasonic CT scanner and spa-like consumer imaging experience.

## Problem

Full-body imaging is expensive, slow, inconvenient, and inaccessible for routine preventive self-knowledge.

## Workaround

MRI, CT, DEXA, conventional ultrasound, concierge screening clinics, executive health checks.
...
Not found. No public market sizing statement from the company was verifiable. The $29.58B TAM in the entry likely refers to the global preventive health screening market (analyst estimates).
...
Neko Health (preventive full-body scanning, different modality)

## Complements

Concierge health platforms, wearable companies (Apple Health, Garmin), GP referral networks.

## Value chain position

**Downstream of:** Consumer demand for preventive health data
**Upstream of:** Clinical follow-up, GP referral, specialist care
